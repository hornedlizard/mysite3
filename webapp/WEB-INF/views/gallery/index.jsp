...
<style type="text/css">
#gallery h1 {
	background: url("${pageContext.request.contextPath }/assets/images/gallery.png") 0 0 no-repeat;
...
.del-button {
	background: url("${pageContext.request.contextPath }/assets/images/delete-image.png") 0 0 no-repeat;
